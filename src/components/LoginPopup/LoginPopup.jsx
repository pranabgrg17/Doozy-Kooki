    ...
    <div className='login-popup'>
      <form onSubmit={onLogin} className="login-popup-container">
        ...
        <div className="login-popup-inputs">
          {currState === "Sign Up" && (
            <>
              <input name="name" onChange={onChangeHandler} value={data.name} placeholder='Name' required />
              ...
              <input name="phone" type="tel" onChange={onChangeHandler} value={data.phone} placeholder="Phone Number" required />
            </>
          )}
